...
def send_reset_email(to_email, to_name, code):
    ...
    payload = {
        "sender": {"name": sender_name, "email": sender_email},
        "to": [{"email": to_email, "name": to_name}],
        "subject": "Reinitialisation de votre mot de passe TalibDrive",
        "htmlContent": f"""
        <div style="font-family: Arial, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px;">
            <h2 style="color: #15803d;">TalibDrive</h2>
            <p>Bonjour {to_name},</p>
            ...
            <p style="color: #666; font-size: 14px;">Ce code expire dans 15 minutes.</p>
            <p style="color: #999; font-size: 12px; margin-top: 30px;">Si vous n'avez pas demande cette reinitialisation, ignorez cet email.</p>
        </div>
        """
    }
