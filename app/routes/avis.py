...
TAGS_CONDUCTEUR = ["Ponctuel", "Vehicule propre", "Bonne conduite", "Sympathique"]
...
def noter(res_id, cible_id):
    ...
    if existing:
        flash("Vous avez deja note ce trajet.", "error")
        return redirect(url_for("reservations.mes_reservations"))
